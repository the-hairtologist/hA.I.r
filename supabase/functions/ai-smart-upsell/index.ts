...
import {
  checkRateLimit as checkRateLimitShared,
      ...
      'https://ai.gateway.lovable.dev/v1/chat/completions',
      {
        ...
        body: JSON.stringify({
          ...
          messages: [
            ...
            {
              role: 'user',
              content: `Suggest an upsell for this context:\n${JSON.stringify(userContext, null, 2)}`,
            },
          ],
          tools: [
            {
                ...
                parameters: {
                  ...
                  properties: {
                    ...
                    reasoning: {
                      type: 'string',
                      description:
                        'Clear, client-friendly explanation of why this upsell makes sense',
                    },
                    incomeBoost: {
                      type: 'number',
                    ...
                    confidence: {
                      type: 'number',
                      description:
                        'Confidence score 0-100 based on context quality',
                    },
                  },
