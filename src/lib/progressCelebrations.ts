...
const appointmentMilestones: MilestoneConfig[] = [
  ...
  {
    threshold: 10,
    message: "🎊 10 appointments! You're on fire!",
    confettiIntensity: 'medium',
  },
  {
    threshold: 25,
    message: '⭐ 25 appointments milestone!',
    confettiIntensity: 'heavy',
  },
  {
    threshold: 50,
    message: '🏆 50 appointments! Incredible work!',
    confettiIntensity: 'heavy',
  },
  {
    threshold: 100,
    message: "💎 100 appointments! You're a pro!",
    confettiIntensity: 'heavy',
  },
];
...
const clientMilestones: MilestoneConfig[] = [
  ...
  {
    threshold: 5,
    message: '👥 5 clients! Building your base!',
    confettiIntensity: 'light',
  },
  {
    threshold: 10,
    message: "🎯 10 clients! You're growing!",
    confettiIntensity: 'medium',
  },
  {
    threshold: 25,
    message: '🌟 25 clients! Amazing growth!',
    confettiIntensity: 'medium',
  },
  {
    threshold: 50,
    message: "🚀 50 clients! You're unstoppable!",
    confettiIntensity: 'heavy',
  },
  {
    threshold: 100,
    message: '👑 100 clients! Legendary status!',
    confettiIntensity: 'heavy',
  },
];
...
const formulaMilestones: MilestoneConfig[] = [
  {
    threshold: 1,
    message: '🧪 First formula created!',
    confettiIntensity: 'light',
  },
  {
    threshold: 10,
    message: '🎨 10 formulas! Master mixer!',
    confettiIntensity: 'medium',
  },
  {
    threshold: 25,
    message: '🌈 25 formulas! Color genius!',
    confettiIntensity: 'heavy',
  },
];
