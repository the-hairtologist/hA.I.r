...
export function preventOverflow(additionalClasses?: string): string {
  return safeClasses('w-full max-w-full overflow-x-hidden', additionalClasses);
}
...
export const cardClasses = {
  ...
  padded:
    'w-full max-w-full rounded-lg border bg-card text-card-foreground p-4 sm:p-5 md:p-6',
