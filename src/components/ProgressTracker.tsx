...
const STYLIST_MILESTONES = [
  ...
  },
  {
    ...
    title: 'Complete First Appointment',
  ...
  },
  {
    ...
    description: 'Stand out to clients',
    points: 20,
    icon: '⭐',
  },
  {
    id: '10-appointments',
    title: 'Complete 10 Appointments',
  ...
  },
  {
    ...
    description: 'Automate scheduling',
    points: 30,
    icon: '🔗',
  },
];
...
export const ProgressTracker = () => {
  ...
  const checkMilestone = async (
    ...
    try {
      ...
      logger.error(`Error checking milestone ${milestoneId}`, error, {
        component: 'ProgressTracker',
        milestoneId,
      });
      return false;
    ...
    <Card className="brutal-border brutal-shadow-xs">
      <CardHeader className="p-4 sm:p-6">
        <div className="flex items-center justify-between gap-3">
          ...
          <Badge
            variant="default"
            className="text-sm sm:text-lg px-3 sm:px-4 shrink-0"
          >
            Level {level}
          </Badge>
        </div>
          ...
          <div className="space-y-2 max-h-[60vh] sm:max-h-80 overflow-y-auto pr-1">
            {milestones.map(milestone => (
              ...
              >
                ...
                <Badge
                  variant="secondary"
                  className="flex-shrink-0 text-[10px] sm:text-xs px-2 sm:px-2.5"
                >
                  +{milestone.points}
                </Badge>
              </div>
