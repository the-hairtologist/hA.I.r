  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="text-center mb-6 xs:mb-8">
        <div className="inline-block border-[3px] border-black px-4 py-2 mb-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] animate-pulse-subtle" style={{ backgroundColor: 'hsl(140 45% 38%)' }}>
