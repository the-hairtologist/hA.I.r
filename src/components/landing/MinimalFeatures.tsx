...
const featuresA = [
  {
    ...
    description:
      'AI cross-checks your calendar, blocks conflicts, sends alerts before disasters happen. Never lose a client to scheduling chaos again.',
    number: '①',
  },
  {
    icon: Smartphone,
    ...
    description:
      'Automatic text & email reminders mean 90% fewer no-shows. Stop losing money to empty chairs. Keep your schedule full.',
    number: '②',
  },
  {
    icon: Heart,
    ...
    description:
      'Hair history, preferences, formulas—instantly accessible. No more awkward "what did we do last time?" moments. Every client feels special.',
    number: '③',
  },
  {
    icon: Sparkles,
    ...
    description:
      'Every color formula, treatment, product—saved forever. Stop recreating formulas from memory. Consistency = loyalty.',
    number: '④',
  },
  {
    icon: CreditCard,
    ...
    description:
      'Secure in-app payments. No awkward cash exchanges. No spreadsheet nightmares. Just instant deposits to your account.',
    number: '⑤',
  },
  {
    icon: Clock,
    ...
    description:
      '24/7 online booking means clients book while you sleep. Automated workflows handle the busy work. Focus on hair, not admin.',
    number: '⑥',
  },
];
...
const featuresB = [
  {
    ...
    description:
      "AI-powered calendar management lets you see more clients without the stress. Build the fully-booked salon you've always dreamed of.",
    number: '①',
  },
  {
    icon: Smartphone,
    ...
    description:
      'Automated reminders keep clients coming back. 90% retention means predictable income. Build your dream clientele.',
    number: '②',
  },
  {
    icon: Heart,
    ...
    description:
      'Remember every detail effortlessly. Build relationships that turn one-time clients into lifelong fans who refer their friends.',
    number: '③',
  },
  {
    icon: Sparkles,
    ...
    description:
      'Access complete client history instantly. Deliver consistent, perfect results every time. Build your reputation as the best in town.',
    number: '④',
  },
  {
    icon: CreditCard,
    ...
    description:
      'Track earnings automatically. See your business growth in real-time. Build the profitable salon you deserve.',
    number: '⑤',
  },
];
...
const featuresC = [
  {
    ...
    description:
      'One tap to book. One tap to reschedule. AI handles conflicts automatically. It just works.',
    number: '①',
  },
  {
    icon: Smartphone,
    ...
    description:
      'Reminders send automatically. Clients show up on time. You focus on hair, not phone calls.',
    number: '②',
  },
  {
    icon: Heart,
    ...
    description:
      'Client walks in. You tap their name. Their entire history appears. Simple as that.',
    number: '③',
  },
  {
    icon: Sparkles,
    ...
    description:
      'Snap a photo. Save the formula. Access it anytime. No notebooks. No guessing. Just results.',
    number: '④',
  },
  {
    icon: CreditCard,
    ...
    description:
      'Client pays in-app. Money hits your account. No cash counting. No spreadsheets. Done.',
    number: '⑤',
  },
];
    ...
    <div
      ...
      onMouseEnter={e => {
        ...
        e.currentTarget.style.transform =
          'rotateY(2deg) rotateX(-2deg) translateY(-8px) scale(1.02)';
        e.currentTarget.style.boxShadow =
          '8px 8px 0px rgba(0,0,0,0.8), 12px 12px 0px rgba(0,0,0,0.4), 16px 16px 0px rgba(0,0,0,0.2)';
      }}
      onMouseLeave={e => {
        e.currentTarget.style.transform = isVisible
          ? 'rotateY(0deg) rotateX(0deg) translateY(0) scale(1)'
  ...
  return (
    <div className="py-4 xs:py-6 sm:py-8">
      <div className="container mx-auto px-3 xs:px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 xs:gap-5 md:gap-6 max-w-7xl mx-auto">
