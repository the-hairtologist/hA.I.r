...
import { Scissors, Users, TrendingUp, Star, Calendar, Palette, Smartphone } from "lucide-react";
 ...
 * Headline: "Join 5,000+ Stylists Who Never Miss a Booking"
 */
export const LandingVariantB = ({ onCTAClick }: LandingVariantBProps) => {
  const navigate = useNavigate();

  useEffect(() => {
    logger.info('[Landing Variant B] Rendered', { variant: 'B' });
  }, []);
          ...
          <div className="container mx-auto px-3 xs:px-4 sm:px-6 text-center relative z-10 w-full max-w-full">
            <div className="max-w-4xl mx-auto space-y-1.5 xxs:space-y-2 xs:space-y-3 sm:space-y-4">
              ...
              <h1 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-pixel uppercase text-white leading-[1.3] xxs:leading-[1.4] xs:leading-relaxed tracking-wide xs:tracking-wider drop-shadow-[2px_3px_0px_rgba(0,0,0,1)] animate-fade-in px-2 xs:px-4 break-words">
                JOIN 5,000+ STYLISTS<br className="hidden xxs:block" /><span className="xxs:hidden"> </span>WHO NEVER MISS A BOOKING
              </h1>
              ...
              <p className="text-xs xs:text-sm sm:text-base md:text-lg font-sans text-white max-w-3xl mx-auto leading-relaxed animate-fade-in px-3 xs:px-4 break-words" style={{ animationDelay: '100ms' }}>
                Trusted by top professionals to automate scheduling, reminders, and client management
              </p>
              ...
              {/* Counters - More prominent in this variant */}
