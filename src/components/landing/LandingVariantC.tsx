...
import { Scissors, Clock, Zap, DollarSign, Calendar, Palette, Smartphone } from "lucide-react";
  ...
  return (
    <>
      <main id="main-content" className="pt-16">
        ...
        <section className="relative bg-secondary py-4 xs:py-6 sm:py-8 md:py-12 lg:py-16 overflow-hidden flex items-center" style={{
          backgroundImage: `
            ...
            <div className="max-w-4xl mx-auto space-y-1.5 xxs:space-y-2 xs:space-y-3 sm:space-y-4">
              ...
              <div className="flex justify-center gap-4 sm:gap-5 mb-3 sm:mb-4 animate-fade-in">
                <div className="w-11 h-11 xs:w-12 xs:h-12 sm:w-14 sm:h-14 brutal-border-4 border-black bg-secondary flex items-center justify-center animate-bounce brutal-shadow-md">
                  <Clock className="h-5 w-5 xs:h-6 xs:w-6 sm:h-7 sm:w-7 text-black" strokeWidth={2.5} />
                </div>
                <div className="w-11 h-11 xs:w-12 xs:h-12 sm:w-14 sm:h-14 brutal-border-4 border-black bg-success flex items-center justify-center animate-bounce brutal-shadow-md" style={{ animationDelay: '0.1s' }}>
                  <Zap className="h-5 w-5 xs:h-6 xs:w-6 sm:h-7 sm:w-7 text-success-foreground" strokeWidth={2.5} fill="currentColor" />
                </div>
                <div className="w-11 h-11 xs:w-12 xs:h-12 sm:w-14 sm:h-14 brutal-border-4 border-black bg-secondary flex items-center justify-center animate-bounce brutal-shadow-md" style={{ animationDelay: '0.2s' }}>
                  <DollarSign className="h-5 w-5 xs:h-6 xs:w-6 sm:h-7 sm:w-7 text-black" strokeWidth={2.5} />
                </div>
              </div>
              ...
              <h1 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-pixel uppercase text-black leading-[1.3] xxs:leading-[1.4] xs:leading-relaxed tracking-wide xs:tracking-wider drop-shadow-[2px_3px_0px_rgba(255,255,255,0.8)] animate-fade-in px-2 xs:px-4 break-words">
                SAVE 10+ HOURS<br className="hidden xxs:block" /><span className="xxs:hidden"> </span>EVERY WEEK
              </h1>
              ...
              <p className="text-xs xs:text-sm sm:text-base md:text-lg font-sans text-black max-w-3xl mx-auto leading-relaxed animate-fade-in px-3 xs:px-4 break-words" style={{ animationDelay: '100ms' }}>
                Stop wasting time on scheduling chaos. Automate bookings, reminders, and follow-ups instantly
              </p>
              ...
              <div className="mt-1.5 xs:mt-2 sm:mt-3 animate-fade-in" style={{ animationDelay: '400ms' }}>
                <Suspense fallback={<div className="relative w-full max-w-[180px] xs:max-w-[220px] sm:max-w-[280px] md:max-w-[320px] mx-auto h-[400px] xs:h-[450px] sm:h-[500px] border-[4px] border-black bg-white/10 backdrop-blur-sm rounded-[32px] animate-pulse" />}>
                  <HeroPhoneMockup />
                </Suspense>
              </div>
