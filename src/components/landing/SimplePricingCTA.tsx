...
export const SimplePricingCTA = () => {
  ...
  return (
    <div className="container mx-auto px-4" ref={ref}>
      <div
        className={`max-w-4xl mx-auto text-center transition-all duration-500 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}
      >
        <div className="mb-10">
          <div className="flex justify-center gap-6 mb-5">
            ...
            <div
              className="w-16 h-16 border-4 border-black bg-secondary flex items-center justify-center animate-bounce"
              style={{ animationDelay: '0.1s' }}
            >
              <Zap className="h-8 w-8 text-secondary-foreground" />
            </div>
            <div
              className="w-16 h-16 border-4 border-black bg-primary flex items-center justify-center animate-bounce"
        ...
        <Button
          ...
          className="text-sm xs:text-base sm:text-lg px-8 xs:px-12 py-6 xs:py-8 font-pixel uppercase bg-secondary text-success hover:bg-secondary/90 brutal-border-bold border-black shadow-brutal-xl hover:shadow-brutal-2xl transition-all duration-300 hover:-translate-y-1 rounded-none group"
        >
