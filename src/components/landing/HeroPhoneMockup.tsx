import { Calendar, MessageSquare, Clock, CheckCircle2, Sparkles } from "lucide-react";
  ...
  return (
    <div ref={ref} className={`relative w-full max-w-[220px] xs:max-w-[280px] sm:max-w-[360px] mx-auto mt-6 xs:mt-10 sm:mt-12 transition-all duration-700 ${animationsEnabled && isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
      ...
      <div className="relative border-[4px] border-black bg-white shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] rounded-[32px] overflow-hidden transform hover:shadow-[14px_14px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-all duration-300">
        ...
        {/* Phone Screen */}
        <div className="relative bg-gradient-to-br from-primary via-primary to-primary/80 px-6 pt-8 pb-6" style={{
          backgroundImage: `
          ...
          <div className="mb-4 flex items-center justify-between">
            <div>
              <h3 className="font-pixel text-white text-xs uppercase mb-1">TODAY'S SCHEDULE</h3>
            ...
            <div className="px-2 py-1 bg-accent border-[2px] border-black animate-pulse">
              <span className="font-pixel text-accent-foreground text-[8px]">LIVE</span>
            </div>
          </div>
            ...
            <div 
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-sans text-[10px] text-secondary-foreground/90 font-bold">Sarah Chen - Color & Cut</p>
                  <p className="font-sans text-[9px] text-secondary-foreground/70">Tomorrow at 2:00 PM • $180</p>
                </div>
                <CheckCircle2 className="h-5 w-5 text-accent flex-shrink-0 animate-bounce" style={{ animationDuration: '2s' }} />
              </div>
            </div>
