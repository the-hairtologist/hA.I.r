...
/**
 * Variant A (Control): Problem-focused headline
 * Emphasizes pain point: "Stop Losing Clients to Missed Texts"
 */
export const LandingVariantA = ({ onCTAClick }: LandingVariantAProps) => {
  const navigate = useNavigate();

  useEffect(() => {
    logger.info('[Landing Variant A] Rendered', { variant: 'A' });
  }, []);
