  ...
  return (
    <>
      <main id="main-content" className="pt-16">
        ...
        <section
          className="relative bg-primary py-4 xs:py-6 sm:py-8 md:py-12 lg:py-16 overflow-hidden flex items-center"
          style={{
            backgroundImage: `
        ...
        >
          <div className="container mx-auto px-3 xs:px-4 sm:px-6 text-center relative z-10 w-full max-w-full">
            <div className="max-w-4xl mx-auto space-y-1.5 xxs:space-y-2 xs:space-y-3 sm:space-y-4">
              ...
              <p
                className="text-[8px] xxs:text-[9px] xs:text-[10px] font-sans text-primary-foreground/80 animate-fade-in px-3 break-words"
