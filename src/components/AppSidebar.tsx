...
export function AppSidebar({ userRole }: AppSidebarProps) {
  ...
  const stylistAllItems: SidebarItem[] = [
    ...
    { 
      ...
      group: "business",
      children: [
        { id: "finance-commissions", title: "Product Commissions", url: "/finance#commissions", icon: Package, gradient: "from-emerald-500 to-teal-500", group: "business" },
        { id: "finance-affiliate", title: "Affiliate Code", url: "/finance#affiliate", icon: Tag, gradient: "from-emerald-500 to-teal-500", group: "business" },
      ]
    },
