...
export const MobileBottomNav = () => {
  ...
  const stylistItems: NavItem[] = [
    { icon: Calendar, label: "Appointments", path: "/appointments", gradient: "from-cyan-start to-cyan-end", highlight: false },
  ...
  const clientItems: NavItem[] = [
    { icon: Home, label: "Home", path: "/dashboard", gradient: "from-purple-start to-purple-end", highlight: false },
