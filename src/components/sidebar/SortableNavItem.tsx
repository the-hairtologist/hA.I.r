  ...
  return (
    <li ref={setNodeRef} style={style} className="list-none">
      {hasChildren ? (
        <>
          <div 
            className={`flex items-center gap-3 w-full cursor-pointer transition-colors duration-200 px-2 py-2 rounded-md min-h-[44px] ${
          ...
          {!collapsed && (
            ...
            >
              <ul className="mt-1 mb-2 ml-4 space-y-1">
