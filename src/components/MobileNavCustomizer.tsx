...
const SortableNavItem = ({ item, isEnabled, onToggle }: { 
  item: NavItem; 
  isEnabled: boolean; 
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>
                Customize your mobile navigation bar ({enabledCount}/{maxItems} items)
              </CardDescription>
            </div>
          </div>
          <Button
      ...
      <CardContent className="space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm space-y-1">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-1 ml-2">
                ...
                <li>Keep {minItems}-{maxItems} items for best experience</li>
        ...
        <div className="pt-4 border-t">
          <div className="flex items-center justify-between text-sm">
            ...
            <Badge variant={enabledCount >= minItems && enabledCount <= maxItems ? "default" : "destructive"}>
