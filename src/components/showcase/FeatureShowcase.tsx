...
const features: Feature[] = [
  {
    ...
    description: "Generate professional color formulas in seconds. AI analyzes hair type, color history, and desired results to create perfect formulas every time.",
  ...
  },
  {
    ...
    description: "Stop playing phone tag. Clients book themselves 24/7, get automatic reminders, and you track everything from your phone.",
  ...
  },
  {
    ...
    description: "Smart scheduling fills empty slots. Track earnings in real-time. Get referral bonuses. Never miss another booking opportunity.",
  ...
  },
  {
    ...
    description: "You're never at a desk. We get it. Everything works perfectly on your phone - check schedule, message clients, generate formulas.",
  ...
  },
  {
    ...
    description: "Pick your stylist, choose a time, confirm. That's it. No waiting on hold, no voicemails, instant confirmation.",
  ...
  },
  {
    ...
    description: "Questions about your hair? Message your stylist anytime. Skip the salon receptionist and get answers from who knows you best.",
  ...
  },
  {
    ...
    description: "Branded booking page, stunning portfolio, automated reviews. Clients see you as the premium choice before they even book.",
  ...
  },
  {
    ...
    description: "Smart reminders for rebooking. Track client preferences. Never forget their formula. Turn one-time visits into lifelong clients.",
