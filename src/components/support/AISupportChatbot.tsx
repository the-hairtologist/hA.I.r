  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content:
        "Hi! I'm your AI support assistant. I can help with:\n• Appointment bookings\n• Service information\n• Rescheduling requests\n• General questions\n\nHow can I assist you today?",
      timestamp: new Date(),
    },
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const errorMessage: Message = {
        role: 'assistant',
        content:
          "I'm sorry, I'm experiencing technical difficulties. Please try again in a moment, or contact support directly if this persists.",
        timestamp: new Date(),
      };
        ...
        <div className="p-4 border-t-2 border-border">
          ...
          <div className="flex items-start gap-2 mt-2">
            ...
            <p className="text-xs text-muted-foreground">
              AI-powered support with access to your appointments and services.
              Ask about booking, rescheduling, pricing, or services!
            </p>
          </div>
        </div>
      </CardContent>
