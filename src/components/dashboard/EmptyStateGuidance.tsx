...
export const EmptyStateGuidance = ({ type }: EmptyStateGuidanceProps) => {
  ...
  const configs = {
    appointments: {
      ...
      description:
        'Get started by adding your first client and scheduling an appointment',
    ...
    clients: {
      ...
      description:
        'Start building your clientele by adding clients or inviting them to connect',
      cta: 'Add Your First Client',
      action: () => navigate('/clients'),
    ...
    messages: {
      ...
      description:
        'Once you connect with clients, your conversations will appear here',
      cta: 'View Clients',
      action: () => navigate('/clients'),
  ...
  return (
    ...
    >
      <CardContent className="py-12 text-center">
        ...
        <Button onClick={config.action} className="gap-2">
