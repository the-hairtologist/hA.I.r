...
export const DashboardStats = memo(
  ({ stats, userRole }: DashboardStatsProps) => {
    const hasNoData =
    ...
    const stylistStats: StatItem[] = [
      {
        ...
        emptyHelp: hasNoData
          ? 'Start by adding services and clients, then create your first appointment'
          : undefined,
      },
      {
        ...
        variant: 'gradient' as const,
        emptyHelp: hasNoData
          ? 'Schedule appointments to fill your week and grow your business'
          : undefined,
      },
      {
      ...
      },
      {
        ...
        variant: 'gradient' as const,
        emptyHelp: hasNoData
          ? 'Add your first client to start building your client base'
          : undefined,
      },
    ];
