...
export const ProactiveInsightsPanel: React.FC<ProactiveInsightsPanelProps> = ({
  ...
  const { insights, loading, lastGenerated, regenerate } =
    useProactiveInsights(stylistId);
