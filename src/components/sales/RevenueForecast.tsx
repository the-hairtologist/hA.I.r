          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Based on your current booking trends, you're projected to
                increase revenue by 15% this quarter. Peak days are
                Tuesday-Thursday. Consider adding more availability on these
                days.
              </p>
            </div>
          </div>
