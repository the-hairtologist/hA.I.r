...
export function SecurityHealthScore() {
  const { data: healthData, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const [failedLogins, suspiciousActivity, recentAudits, activeUsers] =
        await Promise.all([
          supabase
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute -bottom-20 -left-20 w-40 h-40 bg-accent/5 rounded-full blur-3xl animate-pulse-ring"
        ...
        <div className="flex-1 space-y-3">
          ...
          <p className="text-[10px] sm:text-xs text-muted-foreground uppercase tracking-wide">
            ...
            <span className="font-bold text-foreground">
              {healthData?.metrics.recentAudits || 0}
            </span>{' '}
        ...
        {[
          {
            ...
            value: healthData?.metrics.failedLogins || 0,
          },
          {
            label: 'Suspicious Activity',
            value: healthData?.metrics.suspiciousActivity || 0,
          },
          {
            label: 'Security Events (7d)',
            value: healthData?.metrics.recentAudits || 0,
          },
          {
            label: 'Active Users',
