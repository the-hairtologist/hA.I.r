...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        'relative flex w-full min-w-0 flex-col p-2 group-data-[collapsible=icon]:p-0 group-data-[collapsible=icon]:py-2',
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    data-sidebar="menu"
    className={cn(
      'flex w-full min-w-0 flex-col gap-2 group-data-[collapsible=icon]:items-center group-data-[collapsible=icon]:gap-3',
      className
    )}
    {...props}
  />
