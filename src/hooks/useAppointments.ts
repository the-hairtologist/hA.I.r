...
export const appointmentKeys = {
  ...
  listByStylist: (stylistId: string, page?: number) =>
    page
      ...
      : ([...appointmentKeys.lists(), 'stylist', stylistId] as const),
  listByClient: (clientId: string) =>
    [...appointmentKeys.lists(), 'client', clientId] as const,
 ...
 */
export const useAppointmentsByStylist = (
    ...
    onSuccess: newAppointment => {
      ...
      if (newAppointment.client_id) {
        queryClient.invalidateQueries({
          queryKey: appointmentKeys.listByClient(newAppointment.client_id),
        });
      }
