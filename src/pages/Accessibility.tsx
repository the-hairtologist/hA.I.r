      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <Card className="p-8">
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <p>
              hA.I.r is committed to ensuring digital accessibility for people with disabilities. We are continually
              improving the user experience for everyone and applying the relevant accessibility standards.
            </p>

            <h2>Conformance Status</h2>
            <p>
              We strive to conform to <strong>WCAG 2.1 Level AA</strong> (Web Content Accessibility Guidelines).
            ...
            <ul>
              ...
              <li><strong>WCAG 2.1 Level AA:</strong> Partially Conformant (~95%)</li>
              <li><strong>Section 508:</strong> Substantially Conformant</li>
            </ul>
            ...
            <ul>
              ...
              <li>Sufficient time to read and use content (no auto-advancing)</li>
            </ul>
            ...
            <p>
              ...
              description of known limitations and potential solutions:
            </p>

            <ul>
              <li>
                <strong>Third-party content:</strong> Some embedded content (e.g., social media embeds) may not
                be fully accessible. We are working with providers to improve this.
              </li>
              <li>
                <strong>Complex data visualizations:</strong> Some charts may be challenging for screen reader users.
                We provide data tables as alternatives where possible.
              </li>
              <li>
                <strong>Real-time updates:</strong> Some dynamic content updates may require page refresh for
                optimal screen reader experience.
              </li>
            </ul>
            ...
            <h3>Tested With:</h3>
            <ul>
              <li><strong>Windows:</strong> NVDA 2024+, JAWS 2024+</li>
              <li><strong>Mac:</strong> VoiceOver (Safari, Chrome)</li>
            ...
            <p>
              We welcome your feedback on the accessibility of hA.I.r. Please let us know if you encounter
              accessibility barriers:
            </p>

            <div className="bg-muted p-6 rounded-lg space-y-2">
              <div><strong>Email:</strong> accessibility@hair.app</div>
              <div><strong>Support:</strong> support@hair.app</div>
              <div><strong>Response Time:</strong> Within 3 business days</div>
            </div>

            <h2>Formal Complaints</h2>
            <p>
              If you wish to report a compliance issue, you may file a complaint with:
            </p>
            <ul>
              <li>
                <strong>US Department of Justice:</strong>{" "}
                <a href="https://www.ada.gov/filing_complaint.htm" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                  ADA Complaint Form
                </a>
              </li>
              <li>
                <strong>FCC Disabilities Rights Office:</strong>{" "}
                <a href="https://www.fcc.gov/consumers/guides/complaints-about-accessibility" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
            ...
            <p>
              We are committed to continually improving accessibility. Our roadmap includes:
            </p>
            <ul>
              ...
              <li>Incorporating accessibility from the design phase of all new features</li>
            </ul>

            <h2>Technical Specifications</h2>
            <p>
              Accessibility of hA.I.r relies on the following technologies to work:
            </p>
            <ul>
              <li>HTML5</li>
              <li>WAI-ARIA</li>
            ...
            <p>
              hA.I.r assessed the accessibility of our platform by the following approaches:
            </p>
            <ul>
            ...
            <div className="bg-primary/10 p-6 rounded-lg mt-8">
              ...
              <p className="mb-0">
                We recognize that accessibility is an ongoing effort. This statement will be updated as we make
                improvements and receive feedback from our users. Thank you for helping us create a more
