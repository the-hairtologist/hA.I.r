              ...
              <form onSubmit={handleSignIn} className="space-y-4">
                ...
                <div className="space-y-3">
                  <Button
                    ...
                    disabled={loading}
                    className="w-full border-[2px] border-foreground rounded-none flex items-center justify-center gap-2 h-12 hover:bg-accent/5 transition-colors"
                  >
                    ...
                    <span className="font-pixel text-sm uppercase">Sign in with Google</span>
                  </Button>
                </div>
