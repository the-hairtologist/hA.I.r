...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-primary p-4 relative overflow-hidden" style={{
      ...
      <main id="main-content" role="main" aria-label="Authentication" className="w-full max-w-md relative z-10 px-4">
        ...
        <CardHeader className="text-center space-y-2 sm:space-y-3 px-4 sm:px-6 pt-5 sm:pt-6 border-b-[3px] border-black">
          <div className="flex items-center justify-center gap-2 mb-1 sm:mb-2">
            ...
            <CardTitle className="text-xl sm:text-2xl md:text-3xl font-pixel text-foreground uppercase">hA.I.r</CardTitle>
          </div>
                ...
                <div className="space-y-3">
                  ...
                  >
                    <svg className="h-5 w-5" viewBox="0 0 24 24">
                      ...
                      <span className="font-pixel text-xs sm:text-sm uppercase">Sign in with Google</span>
                    </Button>
                </div>
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-2 sm:gap-3">
                    ...
                    >
                      ...
                      <span className="text-[10px] sm:text-xs font-pixel">Google</span>
                    </Button>
                    ...
                    >
                      ...
                      <span className="text-[10px] sm:text-xs font-pixel">Apple</span>
                    </Button>
                  </div>
                </div>
