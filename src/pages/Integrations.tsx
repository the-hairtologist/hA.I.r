            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
              {recommendedIntegrations.map((integration, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${integration.gradient} opacity-5 group-hover:opacity-10 transition-opacity`}
                    />
                    <CardHeader className="pb-3">
                      <div
                        className={`w-12 h-12 rounded-xl bg-gradient-to-br ${integration.gradient} flex items-center justify-center mb-2`}
                      >
                      ...
                      <Dialog>
                        ...
                        {selectedIntegration?.id === integration.id && (
                          <DialogContent className="sm:max-w-md">
                            <DialogHeader>
                              <div
                                className={`w-12 h-12 rounded-xl bg-gradient-to-br ${integration.gradient} flex items-center justify-center mb-4`}
                              >
                                <Icon className="h-6 w-6 text-primary-foreground" />
                              </div>
                              <DialogTitle>
                            ...
                            <div className="space-y-4">
                              {integration.setupType === 'webhook' && (
                                <div className="space-y-2">
                                  ...
                                  <p className="text-xs text-muted-foreground">
                                    Create a webhook in {integration.name} and
                                    paste the URL here
                                  </p>
                                </div>
                              )}
                              ...
                              {integration.setupType === 'api_key' && (
                                <div className="space-y-2">
                                  ...
                                  />
                                  <p className="text-xs text-muted-foreground">
                                    Get your API key from {integration.name}{' '}
                                    dashboard
                                  </p>
                                </div>
                              )}
                              ...
                              {integration.setupType === 'direct' && (
                                <div className="p-4 bg-muted rounded-lg space-y-2">
                                  ...
                                  <p className="text-xs text-muted-foreground">
                                    This integration works automatically once
                                    activated
                                  </p>
                                </div>
                              )}
          ...
          {searchQuery && (
            <div className="flex items-center gap-2 text-muted-foreground">
              ...
              <span className="text-sm">
                ...
                {filteredIntegrations.length !== 1 && 's'} for "{searchQuery}"
              </span>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {filteredIntegrations.map((integration, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${integration.gradient} opacity-10 rounded-full blur-2xl group-hover:opacity-20 transition-opacity`}
                  />
                        ...
                        <div className="space-y-4">
                          {integration.setupType === 'webhook' && (
                            <div className="space-y-2">
                              ...
                              />
                              <p className="text-xs text-muted-foreground">
                                Create a webhook in {integration.name} and paste
                                the URL here
                              </p>
                            </div>
                          )}
                          ...
                          {integration.setupType === 'oauth' && (
                            <div className="p-4 bg-muted rounded-lg space-y-2">
                              ...
                              <p className="text-xs text-muted-foreground">
                                You'll be redirected to {integration.name} to
                                authorize access
                              </p>
                            </div>
                          )}
          ...
          {filteredIntegrations.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground">
                No integrations found{searchQuery && ` for "${searchQuery}"`}
              </p>
            </div>
          )}
        </div>
