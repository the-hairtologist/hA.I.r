...
export default function DevTools() {
  ...
  const handleSeedAppointments = async () => {
    ...
    try {
      ...
      const message =
        err instanceof Error ? err.message : 'Failed to seed appointments';
      addLog(`✗ Error: ${message}`);
      showError(message);
  ...
  const handleSeedFormulas = async () => {
    ...
    try {
      ...
      const message =
        err instanceof Error ? err.message : 'Failed to seed formulas';
      addLog(`✗ Error: ${message}`);
      showError(message);
  ...
  const handleClearTestData = async () => {
    ...
    try {
      ...
      const message =
        err instanceof Error ? err.message : 'Failed to clear test data';
      addLog(`✗ Error: ${message}`);
      showError(message);
