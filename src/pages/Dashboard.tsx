      ...
      <main id="main-content" role="main" aria-label="Dashboard" className="pl-12 w-full">
        ...
        {!isEditMode && stats && (
          <>
            ...
            <div className="mb-6 p-4 rounded-xl border-2 border-white/50 dark:border-white/30 bg-gradient-to-br from-white/30 via-pink-50/20 to-white/20 backdrop-blur-sm shadow-[0_0_15px_rgba(255,255,255,0.1)] animate-fade-in" style={{ animationDelay: '300ms' }}>
