...
export default function Clients() {
  ...
  const [riskFilter, setRiskFilter] = useState<'all' | '60' | '90' | '120'>(
    'all'
  );
  ...
  const handleExportCSV = useCallback(() => {
    ...
    const exportData = filteredClients.map(c => ({
      ...
      days_since_last: c.last_appointment_date
        ? Math.floor(
            (new Date().getTime() -
              new Date(c.last_appointment_date).getTime()) /
              (1000 * 60 * 60 * 24)
          )
        : 'N/A',
    }));
  ...
  const {
    ...
    initialPageSize:
      typeof window !== 'undefined' && window.innerWidth < 768 ? 25 : 50,
  });
      ...
      >
        ...
        {stylistId && (
          <>
            <ClientCSVImport
              stylistId={stylistId}
              onImportComplete={() => refetchClients()}
            />
            <CSVImportDialog />
          </>
        )}
        ...
        <div className="flex flex-col gap-4 mb-6 sm:mb-8">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            ...
            {selectedCount > 0 && stylistId && (
              <ReEngagementDialog
                selectedClients={filteredClients.filter(c =>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <HelpTooltip
                        ...
                        content={{
                          stylist:
                            'Their full name so you can easily find them. First and last name helps avoid confusion with clients who have similar names.',
                        }}
                      />
                    </div>
                    <Input
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <HelpTooltip
                        ...
                        content={{
                          stylist:
                            'Document their natural texture and porosity. This helps you formulate correctly and remember their hair characteristics between visits.',
                        }}
                        examples={[
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <HelpTooltip
                        ...
                        content={{
                          stylist:
                            'CRITICAL safety information. Always ask about PPD, ammonia, and fragrance sensitivities. Document any past reactions to products or chemicals.',
                        }}
                        tips={[
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <HelpTooltip
                        ...
                        content={{
                          stylist:
                            "Your personal notes about the client. What they like, don't like, goals, lifestyle, preferences - anything that helps you give them better service.",
                        }}
                        examples={[
        ...
        {selectedCount > 0 && clients.length > 0 && (
          <div className="mb-6">
            <AIFeatureErrorBoundary featureName="message_composer">
              <AIMessageComposer
                clientName={
                  clients.find(c => c.id === Array.from(selectedIds)[0])
                    ?.full_name || 'Client'
                }
            ...
            <Tabs defaultValue="info" className="w-full">
              <TabsList className="grid w-full grid-cols-4">
                ...
                <TabsTrigger value="ai" className="relative">
                  ...
                  <Badge
                    variant="secondary"
                    className="ml-2 text-[10px] px-1 py-0 h-4 bg-gradient-to-r from-primary to-accent border-0 animate-pulse"
                  >
                    NEW
                  </Badge>
                </TabsTrigger>
              ...
              <TabsContent value="timeline">
                {selectedClient && (
                  <HairMemoryTimeline clientId={selectedClient.id} />
                )}
              </TabsContent>
        ...
        <Dialog open={historyDialogOpen} onOpenChange={setHistoryDialogOpen} modal={true}>
          <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
            ...
            {selectedClientId && (
              <ClientHistoryTimeline clientId={selectedClientId} />
            )}
          </DialogContent>
        </Dialog>
      </main>
