      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <Card className="p-8">
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <p>
              <strong>Company:</strong> hA.I.r™ (Hair Management Platform)
              <br />
              ...
              <br />
              <strong>Address:</strong> 8 The Green, Suite A, Dover, DE 19901,
              United States
            </p>
            ...
            <ul>
              <li>
                <strong>With stylists/clients:</strong> To facilitate
                appointments and services
              </li>
              <li>
                <strong>Service providers:</strong> Third parties who provide
                services on our behalf (Supabase for hosting, Stripe for
                payments)
              </li>
              <li>
            ...
            <ul>
              <li>
                <strong>User Profiles:</strong> Active account + 2 years after
                inactivity
              </li>
              <li>
                <strong>Appointments:</strong> 7 years (tax and legal
                compliance)
              </li>
              <li>
              ...
              <li>
                <strong>Analytics Data:</strong> 26 months (GDPR standard)
              </li>
              <li>
                <strong>Inactive Client Data:</strong> Automatically anonymized
                after 2 years without appointments
              </li>
            </ul>
            ...
            <p>
              ...
              for analytics and marketing. You can manage your cookie
              preferences through our cookie consent banner. See our{' '}
            ...
            <ul>
              <li>
                <strong>Hair Formula Suggestions:</strong> AI analyzes hair type
                and preferences to suggest formulas
              </li>
              <li>
                <strong>Stylist Matching:</strong> Helps clients find suitable
                stylists based on preferences
              </li>
              <li>
                <strong>Chat Assistance:</strong> AI-powered hair consultation
                chatbot
              </li>
            </ul>
            <p>
              <em>
                Important: AI recommendations are assistive only. All final
                decisions are made by users and stylists. No high-risk automated
            ...
            <ul>
              <li>
                <strong>Supabase:</strong> Database, authentication, and hosting
                (US-based)
              </li>
              <li>
              ...
              <li>
                <strong>Twilio:</strong> SMS notifications (with explicit
                consent)
              </li>
              <li>
                <strong>Lovable AI:</strong> AI-powered features (Gemini/GPT
                models)
              </li>
            </ul>
            <p>
              Data transfers to these services are protected by Standard
              Contractual Clauses (SCCs) and appropriate safeguards.
            </p>

            <h2>10. International Data Transfers</h2>
            <p>
              Your data may be processed in the United States and other
              countries. We use Standard Contractual Clauses (SCCs) and
            ...
            <p>
              ...
              knowingly collect information from individuals under 18. If you
              believe a minor has provided us with personal information, please
              contact us immediately at ThehA.I.rtologist@gmail.com.
            </p>

            <h2>12. Changes to Privacy Policy</h2>
            <p>
              We may update this privacy policy from time to time. Material
              changes will be notified via email at least 30 days before taking
              effect.
            </p>
            ...
            <p>
              ...
              <strong>ThehA.I.rtologist@gmail.com</strong>
            </p>
