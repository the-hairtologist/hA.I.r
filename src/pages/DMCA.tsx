      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <Card className="p-8">
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <p>
              hA.I.r respects the intellectual property rights of others and
              expects users to do the same. In accordance with the DMCA, we will
              respond to valid notices of copyright infringement.
            </p>
            ...
            <p>
              ...
              platform, please notify our copyright agent as set forth below.
            </p>

            <h3>Required Information for DMCA Takedown Notice:</h3>
            <ol>
              <li>
                <strong>Identification of the copyrighted work</strong> claimed
              ...
              <li>
                <strong>Identification of the material</strong> that is claimed
                to be infringing or to be the subject of infringing activity and
                that is to be removed, and information reasonably sufficient to
                permit us to locate the material (including URL).
              </li>
              <li>
              ...
              <li>
                <strong>A statement by you</strong> that you have a good faith
                belief that use of the material in the manner complained of is
                not authorized by the copyright owner, its agent, or the law.
              </li>
              <li>
                <strong>A statement by you</strong>, made under penalty of
            ...
            <p>
              ...
              agent, or pursuant to the law, to upload and use the content, you
              may send a counter-notice to our Copyright Agent containing the
            ...
            <ol>
              ...
              <li>
                ...
                (or if you reside outside the United States, for any judicial
                district in which we may be found), and that you will accept
            ...
            <p>
              ...
              at our sole discretion, accounts of users who are deemed to be
              repeat infringers. We may also, at our sole discretion, limit
              access to the platform and/or terminate the accounts of any users
            ...
            <h2>False Claims</h2>
            <p>
              <strong className="text-warning">WARNING:</strong> Under Section
              512(f) of the DMCA, any person who knowingly materially
            ...
            <ul>
              ...
              <li>
                <strong>Content Removal:</strong> Within 72 hours of valid
                notice
              </li>
              <li>
                <strong>Counter-Notice Review:</strong> 10-14 business days
              </li>
              <li>
                <strong>Restoration:</strong> 10-14 business days after valid
            ...
            <p>
              This DMCA policy applies to the following user-generated content
              on our platform:
            </p>
            <ul>
              ...
              <li>
                Hair formula descriptions (if copied from copyrighted sources)
              </li>
            ...
            <p>
              <strong>Note:</strong> The hA.I.r platform itself, including its
              code, algorithms, UI/UX design, branding, and AI models, is
              proprietary and protected by copyright, trademark, and trade
              secret law. Unauthorized use, reproduction, or distribution of
              platform content is prohibited and subject to legal action.
            </p>

            <h2>Contact Information</h2>
            <p>
              For any questions about this DMCA policy, please contact:
              <br />
              <strong>Email:</strong> ThehA.I.rtologist@gmail.com
            </p>
            ...
            <div className="bg-primary/10 p-6 rounded-lg mt-8">
              ...
              <p className="mb-0">
                This DMCA policy is a legal document. If you have any questions
                about your rights or obligations under this policy, please
                consult an attorney. Making false claims under the DMCA can
