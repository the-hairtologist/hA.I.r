  ...
  const adminFeatures = [
    {
      ...
      description:
        'Full platform control with live metrics and system management',
      icon: Crown,
      path: '/admin/command',
    ...
    },
    {
      title: 'System Health',
      description:
        'Monitor errors, performance, database integrity, AI systems',
      icon: Activity,
      path: '/system-health',
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="font-sans text-muted-foreground text-lg">
            Your comprehensive guide to every feature, page, and function in the
            platform
          </p>
        </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
            {adminFeatures.map(feature => (
              <Card
                key={feature.path}
                className="border-4 border-foreground shadow-brutal hover:shadow-brutal-lg transition-all cursor-pointer"
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
            {stylistFeatures.map(feature => (
              <Card
                key={feature.path}
                className="border-2 border-foreground hover:border-primary transition-all cursor-pointer"
                onClick={() => navigate(feature.path)}
              >
                <CardHeader>
                  <div className="flex items-start justify-between">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
            {clientFeatures.map(feature => (
              <Card
                key={feature.path}
                className="border-2 border-foreground hover:border-blue-500 transition-all cursor-pointer"
                onClick={() => navigate(feature.path)}
              >
                <CardHeader>
                  <div className="flex items-start justify-between">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
            {aiFeatures.map(feature => (
              <Card
                key={feature.path}
                className="border-2 border-foreground hover:border-violet-500 transition-all cursor-pointer bg-gradient-to-br from-violet-500/5 to-transparent"
                onClick={() => navigate(feature.path)}
              >
                <CardHeader>
                  <div className="flex items-start justify-between">
        ...
        <section>
          <div className="flex items-center gap-3 mb-4">
            ...
            <Badge variant="secondary">
              {backendFeatures.length} Functions
            </Badge>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
            {backendFeatures.map(feature => (
              <Card
                key={feature.title}
                className="border-2 border-foreground bg-muted/30"
              >
                <CardHeader>
                  <div className="flex items-start justify-between">
