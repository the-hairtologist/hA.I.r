...
import { Sparkles, Share2, Calendar, ArrowRight, Instagram, Loader2 } from 'lucide-react';
...
export default function DeepLinkTransformation() {
  ...
  useEffect(() => {
    if (id) {
      ...
      enhancedAnalytics.track(ANALYTICS_EVENTS.TRANSFORMATION_SHARED, { appointmentId: id });
    }
  }, [id]);
  ...
  const handleShare = async () => {
    ...
    if (success) {
      ...
      enhancedAnalytics.track('transformation_shared', { appointmentId: id, stylist: stylistName });
    }
  };
    ...
    <div className="min-h-screen-safe bg-gradient-to-br from-primary/5 via-background to-secondary/5">
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            {appointment.service_type && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold capitalize">{appointment.service_type}</p>
                </div>
              </div>
            )}
        ...
        <div className="text-center mt-8 pt-8 border-t">
          <p className="text-sm text-muted-foreground">
            Powered by <span className="font-semibold text-primary">hA.I.r</span>
          </p>
