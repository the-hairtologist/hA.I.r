...
const Knowledge = () => {
  ...
  const articles = [
    // Client-Focused Articles
    {
      ...
      category: 'business',
      description:
        'What to do before your appointment, what to bring, and how to ensure the best results from your salon visit.',
      readTime: '6 min read',
      type: 'article',
      featured: true,
    ...
    },
    {
      ...
      category: 'business',
      description:
        'Learn how to describe what you want, bring inspiration photos effectively, and set realistic expectations with your stylist.',
      readTime: '5 min read',
      type: 'article',
      featured: true,
      targetAudience: 'client' as const,
    ...
    },
    {
      ...
      category: 'business',
      description:
        'Why professional color services cost what they do - from products to time and expertise required.',
      readTime: '7 min read',
      type: 'article',
      featured: false,
    ...
    },
    {
      ...
      category: 'techniques',
      description:
        'Essential tips for maintaining your color, recommended products, and what to avoid after salon visits.',
      readTime: '8 min read',
      type: 'article',
      featured: true,
      targetAudience: 'client' as const,
    ...
    },
    {
      ...
      category: 'techniques',
      description:
        'Why going from dark to platinum takes time, understanding hair health, and planning multi-session transformations.',
    ...
    // Stylist Technique Articles
    {
      ...
      category: 'techniques',
      description:
        'Complete guide to creating natural-looking balayage with proper sectioning, placement, and blending.',
    ...
    },
    {
      ...
      category: 'techniques',
      description:
        'Understanding undertones, neutralization, and how to achieve any color result with confidence.',
      readTime: '8 min read',
      type: 'article',
      featured: false,
      targetAudience: 'stylist' as const,
    ...
    },
    {
      ...
      category: 'techniques',
      description:
        'How texture and porosity affect color results, processing times, and formula adjustments needed.',
    ...
    },
    {
      ...
      category: 'techniques',
      description:
        'Step-by-step solutions for brassy tones, uneven color, over-processing, and more common issues.',
      readTime: '10 min read',
      type: 'article',
      featured: false,
      targetAudience: 'stylist' as const,
    ...
    },
    {
      ...
      category: 'techniques',
      description:
        'The science behind hair damage and how to maintain hair integrity during chemical services.',
      readTime: '11 min read',
      type: 'article',
      featured: false,
      targetAudience: 'stylist' as const,
    ...
    // Stylist Business Articles
    {
      ...
      category: 'business',
      description:
        'Beyond basic listening - reading body language, asking the right questions, and documenting effectively.',
      readTime: '9 min read',
      type: 'article',
      featured: false,
      targetAudience: 'stylist' as const,
    ...
    },
    {
      ...
      category: 'business',
      description:
        'How to say no professionally, manage unrealistic expectations, and navigate pricing discussions.',
      readTime: '8 min read',
      type: 'article',
      featured: false,
      targetAudience: 'stylist' as const,
    ...
    },
    {
      ...
      category: 'business',
      description:
        'Proven strategies for pricing, marketing, and client retention that successful stylists use.',
    ...
    },
    {
      ...
      category: 'business',
      description:
        'Understanding service timing, building in buffer time, and maximizing your chair time revenue.',
      readTime: '10 min read',
      type: 'article',
      featured: false,
      targetAudience: 'stylist' as const,
    ...
    },
    {
      ...
      category: 'business',
      description:
        'Strategies for turning one-time clients into loyal regulars through follow-up and relationship building.',
      readTime: '12 min read',
      type: 'article',
      featured: false,
      targetAudience: 'stylist' as const,
    ...
    },
    {
      ...
      category: 'business',
      description:
        'Grow your following and attract dream clients with strategic content that showcases your work.',
      readTime: '9 min read',
      type: 'article',
      featured: false,
      targetAudience: 'stylist' as const,
    ...
    },
    {
      ...
      category: 'business',
      description:
        'Lighting, angles, and editing tips to showcase your work professionally on social media.',
      readTime: '8 min read',
      type: 'article',
      featured: false,
      targetAudience: 'stylist' as const,
    ...
    },
    {
      ...
      category: 'business',
      description:
        'How to recommend products authentically, increase retail revenue, and help clients maintain results.',
      readTime: '7 min read',
      type: 'article',
      featured: false,
      targetAudience: 'stylist' as const,
    ...
    // Trends for Both
    {
      ...
      category: 'trends',
      description:
        'The hottest color trends this year, from butter blonde to rich espresso browns.',
      readTime: '6 min read',
      type: 'article',
      featured: true,
      targetAudience: 'both' as const,
    ...
    },
    {
      ...
      category: 'trends',
      description:
        'How weather affects hair health and what to do in different seasons.',
      readTime: '7 min read',
      type: 'article',
      featured: false,
      targetAudience: 'both' as const,
            ...
            <CardContent className={mobileFirst.padding.md}>
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm font-sans text-foreground/80 font-medium">
                    Get instant color formulas, corrections, and professional
