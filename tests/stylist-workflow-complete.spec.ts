...
test.describe('Complete Stylist Workflow', () => {
  ...
  test('Full stylist daily workflow', async ({ page }) => {
    ...
    const appointmentsLink = page
      .locator('a[href="/appointments"], button:has-text("Appointments")')
      .first();
  ...
  test('Stylist can view appointment calendar', async ({ page }) => {
    ...
    const listView = page
      .locator('button:has-text("List"), [role="tab"]:has-text("List")')
      .first();
    const calendarView = page
      .locator('button:has-text("Calendar"), [role="tab"]:has-text("Calendar")')
      .first();
  ...
  test('Stylist can use keyboard shortcuts', async ({ page }) => {
    ...
    if ((await dialog.count()) > 0) {
      ...
      const closeButton = page
        .locator('[aria-label*="close" i], button:has-text("Cancel")')
        .first();
  ...
  test('Stylist can toggle availability status', async ({ page }) => {
    ...
    const availabilityToggle = page
      .locator('input[type="checkbox"][id*="availability"], [role="switch"]')
      .first();
...
test.describe('Client Workflow', () => {
  ...
  test('Client can rebook appointments', async ({ page }) => {
    ...
    const rebookButton = page
      .locator('button:has-text("Rebook"), button:has-text("Book Again")')
      .first();
  ...
  test('Client can leave reviews', async ({ page }) => {
    ...
    const reviewButton = page
      .locator('button:has-text("Review"), button:has-text("Rate")')
      .first();
