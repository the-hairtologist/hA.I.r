# AI Hair Genius VS Code PowerShell Integration (Clean Version)
# Add this to your PowerShell profile: $PROFILE
# Or source this file: . .\scripts\vscode-shell-integration-clean.ps1
...
if ($env:TERM_PROGRAM -eq "vscode") {
    ...
    try {
        $integrationPath = & code --locate-shell-integration-path powershell
